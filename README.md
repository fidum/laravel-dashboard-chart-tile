...
return [
    ...
    'tiles' => [
        'charts' => [     
            ...
            'scripts' => [     
                'chart' => null, // Default: https://unpkg.com/chart.js@^2.9/dist/Chart.min.js
                'chartisan' => null, // Default: https://unpkg.com/@chartisan/chartjs@^2.0/dist/chartisan_chartjs.js
                'moment' => null, // Default: https://unpkg.com/moment@^2.27/min/moment-with-locales.min.js
            ],
        ],
    ],
];
